...
class EGNN(nn.Module):
    def __init__(self, str_dim, in_dim, n_layers):      #Dimensions of structure features,embedding_dim, one layer
    ...
    def forward(self, str_feature, coord_feature, edge_index):  #Structure features, semantic features
