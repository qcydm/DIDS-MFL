...
input_csv = "./data/CIC-BoT-IoT.csv"
output_csv = "./data/CIC-BoT-IoT_dealed.csv"
...
class My_Dataset(Dataset, ABC):
    ...
    def raw_file_names(self):
        ...
        return 'CIC-BoT-IoT_dealed.csv'


    @property
    def processed_file_names(self):
        # return 'CiC-ToN-IoT.pt'
        return 'CIC-BoT-IoT_new.pt'
    ...
    def process(self):
        if os.path.exists(f'./data/{self.processed_file_names}'):
            ...
            # for i in range(length):
            #     # src = node_list[i][0]
            #     src_item = node_list[i][0]
            #     # dst = node_list[i][1]
            #     dst_item = node_list[i][1]
            #     for j in range(i + 1, length):
            #         src1 = node_list[j][0]
            #         dst1 = node_list[j][1]
            #         if (src_item == src1) or (src_item == dst1) or (dst_item == src1) or (dst_item == dst1):
